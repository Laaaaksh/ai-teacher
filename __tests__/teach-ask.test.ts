...
const CHUNKS: DocumentChunkRow[] = [
  { id: "1", documentId: "d", order: 0, text: "Ohm's Law states that voltage equals current times resistance.", page: 4, section: "Chapter 4", embedding: null, createdAt: "now" },
  { id: "2", documentId: "d", order: 1, text: "Photosynthesis converts sunlight into chemical energy in plants.", page: 12, section: "Chapter 9", embedding: null, createdAt: "now" },
];
...
const PHOTOSYNTHESIS_CHUNKS: DocumentChunkRow[] = [
  { id: "p1", documentId: "p", order: 0, text: "Photosynthesis takes place in the chloroplasts of plant cells, which contain the green pigment chlorophyll.", page: 1, section: "4.1 Where it happens", embedding: null, createdAt: "now" },
  { id: "p2", documentId: "p", order: 1, text: "In the thylakoid membranes, absorbed light splits water molecules, and the energy is captured as ATP and NADPH.", page: 2, section: "4.2 Light-dependent reactions", embedding: null, createdAt: "now" },
  { id: "p3", documentId: "p", order: 2, text: "In the stroma, the Calvin cycle uses ATP and NADPH to fix carbon dioxide into a three-carbon sugar.", page: 3, section: "4.3 The Calvin cycle", embedding: null, createdAt: "now" },
];
